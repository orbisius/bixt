(function() {
     ...
     * Bixt - https://bixt.net
     * Copyright (C) 2011-2050 Svetoslav Marinov (Slavi) | https://orbisius.com
     * Author: orbisius.com
     *
    ...
    Bixt.Widgets.Words.prototype = {
        ...
        create_link : function (child, parse_params) {
            ...
            // extract the info before dp "https://www.amazon.com/Build-Your-Site-Right-Using/dp/0980455278?tag=devequicrefe-20"
        ...
        // credits: https://www.iamcal.com/publish/articles/js/google_highlighting/
        ...
        parse : function () {
            ...
            if ( document.createElement && (typeof bixt_cfg.branding == 'undefined' || bixt_cfg.branding) ) {
                ...
                divTag.innerHTML = "Affiliate links generated by <a href='https://bixt.net/aff/site/"
        ...
        getMainUrl: function () {
            ...
            if ( (typeof bixt_cfg.env == 'undefined') || bixt_cfg.env != 'live'
                ...
                return ("https:" == document.location.protocol)
                            ? 'https://' + this.domain.development.sslHost + this.domain.development.sslWebPath
                            : 'https://' + this.domain.development.host + this.domain.development.webPath;
            } else {
                return ("https:" == document.location.protocol)
                            ? 'https://' + this.domain.production.sslHost + this.domain.production.sslWebPath
                            : 'https://' + this.domain.production.host + this.domain.production.webPath;
            }
        },

        // returns the location of user's keyword js file
        // e.g. https://s.bixt.net/user_data/a/b/c/d/12345/domain.js?__rnd=123
